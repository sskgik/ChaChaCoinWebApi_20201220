...
function recenttransaction() {
    for (i = 1; i <= 5; i++) {
        var datekey = "sakuradate" + i;
        var amountkey = "sakuraamount" + i;
...
function hystorylog(amount) {
    var a = localStorage.getItem('sakuradate1');
    var b = localStorage.getItem('sakuradate2');
    var c = localStorage.getItem('sakuradate3');
    var d = localStorage.getItem('sakuradate4');
    var e = localStorage.getItem('sakuradate5');
    //時刻取得
    var now = new Date();
    ...
    if (a == null) {
        localStorage.setItem('sakuradate1', date);
        localStorage.setItem('sakuraamount1', amount);
    }
    else if (b == null) {
        localStorage.setItem('sakuradate2', localStorage.getItem('sakuradate1'));
        localStorage.setItem('sakuraamount2', localStorage.getItem('sakuraamount1'));
        localStorage.setItem('sakuradate1', date);
        localStorage.setItem('sakuraamount1', amount);
    }
    else if (a != null && b != null && c == null) {
        localStorage.setItem('sakuradate3', localStorage.getItem('sakuradate2'));
        localStorage.setItem('sakuraamount3', localStorage.getItem('sakuraamount2'));
        localStorage.setItem('sakuradate2', localStorage.getItem('sakuradate1'));
        localStorage.setItem('sakuraamount2', localStorage.getItem('sakuraamount1'));
        localStorage.setItem('sakuradate1', date);
        localStorage.setItem('sakuraamount1', amount);
        ...
        localStorage.setItem('sakuradate4', localStorage.getItem('sakuradate3'));
        localStorage.setItem('sakuraamount4', localStorage.getItem('sakuraamount3'));
        localStorage.setItem('sakuradate3', localStorage.getItem('sakuradate2'));
        localStorage.setItem('sakuraamount3', localStorage.getItem('sakuraamount2'));
        localStorage.setItem('sakuradate2', localStorage.getItem('sakuradate1'));
        localStorage.setItem('sakuraamount2', localStorage.getItem('sakuraamount1'));
        ...
        localStorage.setItem('sakuradate5', localStorage.getItem('sakuradate4'));
        localStorage.setItem('sakuraamount5', localStorage.getItem('sakuraamount4'));
        localStorage.setItem('sakuradate4', localStorage.getItem('sakuradate3'));
        localStorage.setItem('sakuraamount4', localStorage.getItem('sakuraamount3'));
        localStorage.setItem('sakuradate3', localStorage.getItem('sakuradate2'));
        localStorage.setItem('sakuraamount3', localStorage.getItem('sakuraamount2'));
...
function Swaphystorylog(amount) {
    var a = localStorage.getItem('sakuraswapdate1');
    var b = localStorage.getItem('sakuraswapdate2');
    ...
    var date = year + "/" + mon + "/" + day + "\t" + hour + ":" + min + ":" + sec;
    if (a == null) {
        localStorage.setItem('sakuraswapdate1', date);
        localStorage.setItem('sakuraswapamount1', amount);
    }
    else if (b == null || b != null) {
        localStorage.setItem('sakuraswapdate2', localStorage.getItem('sakuraswapdate1'));
        localStorage.setItem('sakuraswapamount2', localStorage.getItem('sakuraswapamount1'));
        localStorage.setItem('sakuraswapdate1', date);
        localStorage.setItem('sakuraswapamount1', amount);
    }
...
function recentswaptransaction() {
    for (i = 1; i <=  2; i++) {
        var swapdatekey = "sakuraswapdate" + i;
        var swapamountkey = "sakuraswapamount" + i;

        var swapdate = localStorage.getItem(swapdatekey);
        var swapamount = localStorage.getItem(swapamountkey) + "SAKURA";
